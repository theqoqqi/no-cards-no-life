    ...
    public class CombatSystem : MonoBehaviour {
        ...
        private async void OnTurnFinished(TurnFinishedEvent e) {
            ...
            if (!isRunning && combatResult.HasValue) {
                GameEvents.Instance.Dispatch<CombatFinishedEvent>(e2 => {
                    e2.Setup(this, combatResult.Value);
                });
        ...
        public void StartCombat() {
            ...
            GameEvents.Instance.Dispatch<CombatStartedEvent>(e => {
                e.Setup(this);
            });
        ...
        private void Dispatch<T>() where T : TurnEvent, new() {
            GameEvents.Instance.Dispatch<T>(e => {
                e.Setup(CurrentTurnPerformer.Entity, currentTurn.Clone());
            });
        }
